      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="px-4 md:px-8">
          ...
          <section className="text-center py-12 md:py-20 relative">
            ...
            ئەم شارەزایێن هەوە نە بۆ خزمەتێن چاککرنا ئامیران ب لەز، باوەرپێکری، و ب نرخەکێ گونجای. ژ کۆمپیوتەرێن سەر مێزێ و لاپتۆپان هەتا تەلەفۆنێن زیرەک و تابلێتان، ئەم کارکرنا وان ڤەدگەرینین دا هوین بەرهەمدار و گرێدای بمینن.
            .
            </p>
